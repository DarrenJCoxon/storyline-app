...
// The skill calls `npx storyline-vsc route <stageId>` at stage boundaries
...
const BALANCED = {
  ...
  // ── Book DNA (Phase 0 — all NF pipelines) ─────────────────────
  // Haiku for structured/capture stages; Sonnet for positioning/promise;
  // Opus for the two stages that most affect commercial success.
  'dna-category':   { model: 'haiku' },
  'dna-reader':     { model: 'sonnet' },
  'dna-transform':  { model: 'sonnet' },
  'dna-idea':       { model: 'opus' },       // differentiation is make-or-break
  'dna-author':     { model: 'sonnet' },
  'dna-promise':    { model: 'sonnet' },
  'dna-comps':      { model: 'sonnet' },
  'dna-voice':      { model: 'haiku' },
  'dna-evidence':   { model: 'haiku' },
  'dna-commercial': { model: 'haiku' },
  'dna-title':      { model: 'sonnet' },
  'dna-consolidate':{ model: 'opus' },       // cross-stage coherence check

  // ── Pipeline A — Prescriptive ──────────────────────────────────
  'pa-thesis':      { model: 'sonnet' },
  'pa-objections':  { model: 'haiku' },
  'pa-framework':   { model: 'sonnet', escalateOn: 'opus' },
  'pa-principles':  { model: 'haiku' },
  'pa-evidence':    { model: 'haiku' },
  'pa-application': { model: 'sonnet' },
  'pa-braid':       { model: 'sonnet' },
  'pa-chapters':    { model: 'sonnet' },
  'pa-opener':      { model: 'haiku' },
  'pa-critique':    { model: 'opus' },
  'pa-master':      { model: 'opus' },

  // ── Pipeline B — Narrative NF ──────────────────────────────────
  'pb-thesis':      { model: 'sonnet' },
  'pb-cast':        { model: 'haiku' },
  'pb-timeline':    { model: 'haiku' },
  'pb-fork':        { model: 'sonnet' },
  'pb-scenes':      { model: 'sonnet' },
  'pb-sourcing':    { model: 'haiku' },
  'pb-theme':       { model: 'sonnet' },
  'pb-chapters':    { model: 'sonnet' },
  'pb-critique':    { model: 'opus' },
  'pb-master':      { model: 'opus' },

  // ── Pipeline C — How-To / Skill Ladder ────────────────────────
  'pc-skill':       { model: 'haiku' },
  'pc-start-level': { model: 'haiku' },
  'pc-end-state':   { model: 'sonnet' },
  'pc-decompose':   { model: 'sonnet' },
  'pc-prereqs':     { model: 'haiku' },
  'pc-lessons':     { model: 'sonnet' },
  'pc-drills':      { model: 'haiku' },
  'pc-milestones':  { model: 'haiku' },
  'pc-examples':    { model: 'sonnet' },
  'pc-critique':    { model: 'opus' },
  'pc-master':      { model: 'opus' },

...
// Pattern mirrors lib/ai/stage-guides.js

// Categories and which pipeline they route to
export const CATEGORY_PIPELINE_MAP = {
...
export function inferPipelineFromCategory(category) {
...
export function getNfDnaGuide(stageId) {
  return NF_DNA_GUIDES[stageId] || null;
}

export const NF_DNA_GUIDE_ORDER = Object.values(NF_DNA_GUIDES)

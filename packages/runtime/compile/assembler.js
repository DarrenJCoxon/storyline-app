...
// Supports string, boolean, and number scalar values only (no lists or maps).
// Returns { body, frontmatter } where body has the frontmatter block stripped.
function parseFrontmatter(raw) {
  ...
  for (const line of fmText.split('\n')) {
    ...
    else if (val !== '') frontmatter[key] = val;
  }

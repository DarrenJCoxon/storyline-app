...
exports.validateSkillTree = validateSkillTree;
exports.saveSkillTree = saveSkillTree;
exports.loadSkillTree = loadSkillTree;
const fs_extra_1 = __importDefault(require("fs-extra"));
const { ensureDir, writeFile, pathExists, readFile } = fs_extra_1.default;
...
function validateSkillTree(nodes, edges) {
    const errors = [];
    const warnings = [];
...
// ── Public API ────────────────────────────────────────────────────────────────
async function saveSkillTree(projectDir, decompose, prereqs, targetSkill) {
    ...
    const jsonPath = (0, path_1.join)(dir, 'skill-tree.json');
    const mdPath = (0, path_1.join)(dir, 'skill-tree.md');
...
async function loadSkillTree(projectDir) {
    const jsonPath = (0, path_1.join)(STORYLINE_DIR(projectDir), 'skill-tree.json');

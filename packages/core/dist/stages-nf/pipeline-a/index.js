...
exports.PIPELINE_A_BY_ID = exports.PIPELINE_A_STAGES = void 0;
exports.getActiveStages = getActiveStages;
exports.runStage = runStage;
exports.extractFrameworkFromStage = extractFrameworkFromStage;
const stage_guides_nf_pipeline_a_js_1 = require("../../ai/stage-guides-nf-pipeline-a.js");
const narrative_voice_nf_js_1 = require("../../ai/narrative-voice-nf.js");
exports.PIPELINE_A_STAGES = [
...
exports.PIPELINE_A_BY_ID = Object.fromEntries(exports.PIPELINE_A_STAGES.map(s => [s.id, s]));
// Active stages filtered by subMode — braid stage only shows in braid mode
function getActiveStages(subMode) {
    return exports.PIPELINE_A_STAGES.filter(s => !s.subModes || s.subModes.includes(subMode));
}
async function runStage(stageId, state) {
    const stage = exports.PIPELINE_A_BY_ID[stageId];
    if (!stage)
        return { error: `Unknown Pipeline A stage: ${stageId}` };
    const guide = (0, stage_guides_nf_pipeline_a_js_1.getPipelineAGuide)(stageId);
    ...
    const critique = state ? (0, narrative_voice_nf_js_1.buildPipelineACritiqueSummary)(stageId, stageData, state.nfStages || {}) : null;
    return {
        status: 'ok',
        stage,
        guide,
...
function extractFrameworkFromStage(nfStages) {

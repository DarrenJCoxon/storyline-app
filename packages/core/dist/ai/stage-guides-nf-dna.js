...
exports.NF_DNA_GUIDE_ORDER = exports.NF_DNA_GUIDES = exports.CATEGORY_PIPELINE_MAP = void 0;
exports.inferPipelineFromCategory = inferPipelineFromCategory;
exports.getNfDnaGuide = getNfDnaGuide;
// Categories and which pipeline they route to
exports.CATEGORY_PIPELINE_MAP = {
...
function inferPipelineFromCategory(category) {
    ...
    for (const [cat, pipeline] of Object.entries(exports.CATEGORY_PIPELINE_MAP)) {
        if (key.includes(cat))
            return pipeline;
    }
    return null;
}
exports.NF_DNA_GUIDES = {
    'dna-category': {
        id: 'dna-category',
...
function getNfDnaGuide(stageId) {
    return exports.NF_DNA_GUIDES[stageId] ?? null;
}
exports.NF_DNA_GUIDE_ORDER = Object.values(exports.NF_DNA_GUIDES)
    .sort((a, b) => a.index - b.index);
//# sourceMappingURL=stage-guides-nf-dna.js.map
...
exports.critiquePipelineAStage = critiquePipelineAStage;
exports.buildPipelineACritiqueSummary = buildPipelineACritiqueSummary;
exports.critiquePipelineBStage = critiquePipelineBStage;
exports.buildPipelineBCritiqueSummary = buildPipelineBCritiqueSummary;
exports.critiquePipelineCStage = critiquePipelineCStage;
exports.buildPipelineCCritiqueSummary = buildPipelineCCritiqueSummary;
exports.critiqueBookDnaStage = critiqueBookDnaStage;
exports.formatCritique = formatCritique;
exports.hasBlockingErrors = hasBlockingErrors;
exports.buildCritiqueSummary = buildCritiqueSummary;
...
function critiquePipelineAStage(stageId, data, allNfStages = {}) {
    const critiquer = PA_CRITIQUERS[stageId];
    if (!critiquer)
        return [];
    return critiquer(data, allNfStages);
}
function buildPipelineACritiqueSummary(stageId, data, allNfStages) {
...
function critiquePipelineBStage(stageId, data, allNfStages = {}) {
    const critiquer = PB_CRITIQUERS[stageId];
    if (!critiquer)
        return [];
    return critiquer(data, allNfStages);
}
function buildPipelineBCritiqueSummary(stageId, data, allNfStages) {
...
function critiquePipelineCStage(stageId, data, allNfStages = {}) {
    const critiquer = PC_CRITIQUERS[stageId];
    if (!critiquer)
        return [];
    return critiquer(data, allNfStages);
}
function buildPipelineCCritiqueSummary(stageId, data, allNfStages) {
...
function critiqueBookDnaStage(stageId, data, allDnaData = {}) {
    const critiquer = CRITIQUERS[stageId];
    if (!critiquer)
        return [];
    return critiquer(data, allDnaData);
}
function formatCritique(issues) {
    if (!issues || issues.length === 0)
        return '✓ No issues flagged for this stage.';
...
function buildCritiqueSummary(stageId, data, allDnaData) {
...
//# sourceMappingURL=narrative-voice-nf.js.map
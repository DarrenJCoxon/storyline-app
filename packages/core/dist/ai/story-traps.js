...
exports.runStoryTraps = runStoryTraps;
const STORY_TRAPS = {
    flatProtagonist: {
        id: 'flatProtagonist',
    ...
    themeFreePlot: {
        ...
        detection: (state) => {
            ...
            if (!bStory?.character || !bStory?.premise)
                return false;
...
//# sourceMappingURL=story-traps.js.map
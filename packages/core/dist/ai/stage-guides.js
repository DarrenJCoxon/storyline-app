...
exports.STAGE_GUIDES = exports.GENRE_VARIANTS = void 0;
exports.getStageGuide = getStageGuide;
exports.buildSystemPrompt = buildSystemPrompt;
exports.GENRE_VARIANTS = {
    ...
    genre: {
        ...
        questions: [
            ...
            { key: 'targetWordCount', label: 'How long do you want this novel to be?', hint: '"around 80k", "short and tight", "epic at 120k" — rough idea is fine', type: 'number', required: true },
            {
                ...
                hint: Object.entries(exports.GENRE_VARIANTS).map(([, v]) => `${v.name}: ${v.description}`).join(' | '),
                type: 'variant',
                required: true,
            },
        ],
...
function getStageGuide(stageId) {
    return exports.STAGE_GUIDES[stageId] ?? null;
}
function buildSystemPrompt(stageId, state) {
...
//# sourceMappingURL=stage-guides.js.map
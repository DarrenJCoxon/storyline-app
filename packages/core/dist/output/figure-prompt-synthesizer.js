...
exports.synthesizeImagePrompt = synthesizeImagePrompt;
...
function synthesizeImagePrompt(purpose, type, figure, book) {
    ...
    // Chart axes
    if (isChart) {
        textElements.push({ text: 'X axis label', position: 'bottom centre' }, { text: 'Y axis label', position: 'left side, rotated' });
    }
...
//# sourceMappingURL=figure-prompt-synthesizer.js.map
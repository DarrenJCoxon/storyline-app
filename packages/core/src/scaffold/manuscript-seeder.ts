...
import type { WritingPlan, FictionChapter, FictionScene, NfChapter, ClaimEvidenceItem } from '../state/writing-plan.js'
...
export function seedNfChapterContent(ch: NfChapter, claims: ClaimEvidenceItem[] = []): string {

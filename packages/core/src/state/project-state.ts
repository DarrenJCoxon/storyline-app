...
export const STAGE_ORDER: StageEntry[] = [
...
export const NF_DNA_STAGE_ORDER: StageEntry[] = [
  { index: 0,  id: 'mode',            name: 'Fiction or Non-Fiction',         nextPrompt: 'mode' },
...
export const NF_PIPELINE_A_STAGE_ORDER: StageEntry[] = [
...
export const NF_PIPELINE_B_STAGE_ORDER: StageEntry[] = [
...
export const NF_PIPELINE_C_STAGE_ORDER: StageEntry[] = [
...
export const NF_ACADEMIC_DNA_STAGE_ORDER: StageEntry[] = [
  { index: 0,  id: 'mode',              name: 'Fiction or Non-Fiction',           nextPrompt: 'mode' },
...
function nfStageOrderFor(pipeline: Pipeline | undefined): StageEntry[] {
  switch (pipeline) {
    ...
    case 'academic': return [...NF_ACADEMIC_DNA_STAGE_ORDER, ...NF_ACADEMIC_STAGE_ORDER]
...
export function stageOrderFor(state: Pick<ProjectState, 'mode' | 'pipeline'> | undefined): StageEntry[] {
  if (!state || state.mode !== 'nonfiction') return STAGE_ORDER

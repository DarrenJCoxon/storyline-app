...
export interface AcademicGuide {
  ...
  variants?: { textbook?: AcademicGuideVariant; 'revision-guide'?: AcademicGuideVariant }
  questions?: any[]
  validation?: string[]
  summary?: any[]
  transition?: string
...
export const ACADEMIC_GUIDES: Record<string, AcademicGuide> = {
...
export function getAcademicGuide(stageId: string): AcademicGuide | null {
  return ACADEMIC_GUIDES[stageId] ?? null
}

export const ACADEMIC_GUIDE_ORDER: AcademicGuide[] = Object.values(ACADEMIC_GUIDES)

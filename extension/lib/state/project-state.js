// Storyline project state — all planning stages and their data
...
export const DEFAULT_STATE = {
  ...
  // ─────────────────────────────────────────────────────────────
  // Mode & pipeline — fiction uses 'novel'; nonfiction uses A/B/C
  // ─────────────────────────────────────────────────────────────
  mode: 'fiction',    // 'fiction' | 'nonfiction'
  pipeline: 'novel',  // 'novel' | 'A' | 'B' | 'C'
  subMode: null,      // 'argument' | 'braid' | 'idea-led' | 'event-led'

  // ─────────────────────────────────────────────────────────────
  // Nonfiction — Book DNA and pipeline-specific stages
  // Empty for fiction projects; populated by /storyline-nf
  // ─────────────────────────────────────────────────────────────
  bookDna: {},
  nfStages: {},
  ...
  // ─────────────────────────────────────────────────────────────
  // Writer settings — where the manuscript prose lives.
  // The VS Code extension scans this path for word counts.
  // Writers who prefer a different layout (e.g. "chapters" or
  // "output") can change this in state.json and the extension
  // picks it up on next save.
  // ─────────────────────────────────────────────────────────────
  writing: {

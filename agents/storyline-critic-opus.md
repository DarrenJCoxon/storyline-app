---
name: storyline-critic-opus
description: "Whole-book cross-stage reasoning critic for Storyline. Use at Stage 13 (Consistency & Critique) and Stage 14 (Master Document). Also invoked as an escalation target when storyline-critic-sonnet produces weak critique on Stage 7 (Beat Sheet) or Stage 10 (Scene Outline critique pass)."
model: opus
color: purple
---

---
name: storyline-critic-sonnet
description: "Structural-reasoning critic for Storyline. Use at Stage 3 (Protagonist), Stage 5 (Relationships), Stage 6 (Logline), Stage 7 (Beat Sheet), Stage 8 (B Story), Stage 9 (Subplots), Stage 10 (Scene Outline — both passes), and Stage 12 (Chapter Flesh-Out). The workhorse tier — every stage that needs Save the Cat judgement but not whole-book cross-stage reasoning."
model: sonnet
color: blue
---

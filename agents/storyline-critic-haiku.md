---
name: storyline-critic-haiku
description: "Fast structured-capture validator for Storyline. Use at Stage 1 (Genre), Stage 2 (Premise), Stage 4 (Supporting Cast), and Stage 11 (Plot Thread Registry) — any stage whose job is to write known-shape data to the Save the Cat state schema."
model: haiku
color: cyan
---

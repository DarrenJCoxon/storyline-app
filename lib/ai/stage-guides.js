...
export const STAGE_GUIDES = {
  genre: {
    ...
    researchTip: 'If this novel is set in a specific time period, profession, or location, capture worldbuilding research now: `storyline research add --title "..." --subtype worldbuilding --tags "setting,<genre>"`. This surfaces automatically when you draft those scenes.',
  },
  ...
  protagonist: {
    ...
    researchTip: 'If your protagonist has a specific occupation or lived experience you want to get right, capture that research: `storyline research add --title "..." --subtype profession --tags "protagonist,<occupation>"`. It will surface in the research panel when you draft scenes featuring them.',
  },
  ...
  sceneOutline: {
    ...
    researchTip: 'Before fleshing out scenes set in specific locations or time periods, capture period and setting research: `storyline research add --title "..." --subtype period --tags "setting,<location>"` then link it to the scene with `storyline research link <id> --to scene:ch<N>-s<N>`. The VS Code research panel will surface it automatically when you draft.',
  },

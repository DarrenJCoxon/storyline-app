...
// Used by the /novel skill to conduct the planning conversation through Claude Code
...
export const STAGE_GUIDES = {
  ...
  premise: {
    ...
    seriesQuestions: [
      ...
      { key: 'bookCount', label: 'How many books do you envision?', type: 'number', default: 3 },
      { key: 'overallArc', label: 'What is the overall arc across all books?' },
      { key: 'firstBookFocus', label: 'What is Book 1 specifically about?' },
    ],
  ...
  relationships: {
    ...
    repeatable: {
      ...
      fields: [
        { key: 'from', label: 'Character 1', required: true },
        { key: 'to', label: 'Character 2', required: true },
        { key: 'type', label: 'Relationship type', hint: 'e.g. "mentor/student", "rivals", "lovers", "parent/child"', required: true },
        { key: 'conflict', label: 'What is the tension between them?', required: false },
        { key: 'mutualWant', label: 'What do they both want that puts them at odds?', required: false },
      ],
    },
    ...
    beats: [
      {
        ...
        questions: [
          ...
          { key: 'contrastToFinalImage', label: 'How will this contrast with the final image?' },
        ],
      },
      {
        id: 'beat02Setup',
      ...
      },
      {
        ...
        questions: [
          ...
          { key: 'choice', label: 'What CHOICE does the protagonist make? (Not "things happen to them" — they choose)' },
      ...
      },
      {
        ...
        questions: [
          { key: 'scene', label: 'Who is the B story character?' },
          { key: 'bStoryPremise', label: 'What is the B story about? (What theme does it explore?)' },
          { key: 'themeStatement', label: 'What is the THEME STATEMENT? (Often stated by B story character)' },
        ],
      },
      {
  ...
  chapterOutline: {
    ...
    persona: 'director',
    opening: `Now we flesh out each chapter with scene-level detail. POV, location, time, conflict, what changes.\n\nEvery scene must justify its existence.`,
    perChapterFields: [
      ...
      { key: 'whatChanges', label: 'What changes by the end of this chapter?', required: true },
      { key: 'beats', label: 'Which beats does this chapter serve?', required: false },

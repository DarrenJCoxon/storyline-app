...
export const DEFAULT_STATE = {
  ...
  premise: {
    ...
    seriesPotential: null,   // { detected: bool, reason: string, suggestion: string }
    seriesContext: {
      isSeries: false,
      seriesTitle: null,
      bookNumber: null,
  ...
  beatSheet: {
    ...
    beats: {
      ...
      beat11BlackMoment: { scene: null, defeatType: null, despair: null, notes: null },
  ...
  bStory: {
    ...
    beats: [],              // How does B story arc mirror or contrast A
    resolution: null,
    connectionToATheme: null,
  },

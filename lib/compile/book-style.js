...
async function loadFrontMatterCss() {
...
export async function applyBookStyle(context) {
  ...
  const effectiveCss = frontMatterCss + primitivesCss + style.css + printResetCss + overrideCss + paragraphStyleOverride(paragraphStyle);
